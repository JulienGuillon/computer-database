...
import com.excilys.computerdatabase.cli.view.MainMenuView;
 ...
 *         21 févr. 2017
 *
 *         Controller for the MainMenuView It is a singleton. Allows to catch
 *         event on view MainMenuView and make validation.
 *
 */
