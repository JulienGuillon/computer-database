...
public class MapperOptional {
	...
	public static List<ComputerDTO> optionalListOfComputersToListOfComputersDTO(Optional<List<Optional<Computer>>> optionalComputers) {
	...
	public static List<Company> optionalListOfCompaniesToListOfCompanies(Optional<List<Optional<Company>>> optionalCompanies) {
